          ...
          <ul className="sd-nav-list">
            ...
            <li>
              <Link href="/user/dashboard"
                className={`sd-nav-link ${isActive("/user/dashboard") ? "active" : ""}`}
              >
            ...
            <li>
              <Link href="/user/browse"
                className={`sd-nav-link ${isActive("/user/browse") ? "active" : ""}`}
              >
                <i className="material-symbols-outlined sd-nav-icon">search</i>
                {isHindi ? "खोजें" : "Browse"}
              </Link>
            </li>

            <li>
              <Link href="/user/mybookings"
                className={`sd-nav-link ${isActive("/user/mybookings") ? "active" : ""}`}
              >
                <i className="material-symbols-outlined sd-nav-icon">calendar_month</i>
                {isHindi ? "मेरी बुकिंग्स" : "My Bookings"}
              </Link>
            </li>

            <li>
              <Link href="/user/pooja"
                className={`sd-nav-link ${isActive("/user/pooja") ? "active" : ""}`}
              >
                <i className="material-symbols-outlined sd-nav-icon">storefront</i>
                {isHindi ? "पूजा बुक करें" : "Book a Puja"}
              </Link>
            </li>
             <li>
  <Link href="/user/familytree"
    className={`sd-nav-link ${isActive("/user/familytree") ? "active" : ""}`}
  >
    <i className="material-symbols-outlined sd-nav-icon">account_tree</i>
    {isHindi ? "परिवार वृक्ष" : "Family Tree"}
  </Link>
</li>

 <li>
  <Link href="/user/calender"
    className={`sd-nav-link ${isActive("/user/calender") ? "active" : ""}`}
  >
    <i className="material-symbols-outlined sd-nav-icon">calendar_month</i>
    {isHindi ? "कैलेंडर" : "Calendar"}
          ...
          <ul className="sd-nav-list">
            ...
            <li>
              <Link href="/geeta" className="sd-nav-link">
                <i className="material-symbols-outlined sd-nav-icon">menu_book</i>
                {isHindi ? "भगवद गीता" : "Bhagavad Gita"}
              </Link>
            </li>
          ...
          <ul className="sd-nav-list">
            ...
            <li>
              <Link href="/user/wallet"
                className={`sd-nav-link ${isActive("/user/wallet") ? "active" : ""}`}
              >
            ...
            <li>
              <Link href="/user/refer"
                className={`sd-nav-link ${isActive("/user/refer") ? "active" : ""}`}
              >
                <i className="material-symbols-outlined sd-nav-icon">
                  card_giftcard
                </i>
                {isHindi ? "रेफर और कमाएँ" : "Refer & Earn"}
              </Link>
            </li>

            <li>
              <Link href="/user/reviews"
                className={`sd-nav-link ${isActive("/user/reviews") ? "active" : ""}`}
              >
            ...
            <li>
              <Link href="/user/profile"
                className={`sd-nav-link ${isActive("/user/profile") ? "active" : ""}`}
              >
            ...
            <li>
              <Link href="/user/support"
                className={`sd-nav-link ${isActive("/user/support") ? "active" : ""}`}
              >
                <i className="material-symbols-outlined sd-nav-icon">
                  help_outline
                </i>
