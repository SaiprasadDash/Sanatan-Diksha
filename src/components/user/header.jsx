              ...
              <nav className="navbar navbar-expand">
                <div className="collapse navbar-collapse justify-content-between">
                  <div className="header-left">
                    {/* <div className="dashboard_bar" style={{ color: 'black' }}>
                      Dashboard
                    </div> */}
                  ...
                  <ul className="navbar-nav header-right">
                            ...
                            <ul className="d-flex align-items-center justify-content-around">
                              ...
                              <li className="nav-item dropdown notification_dropdown">
                                <a className="nav-link bell dz-fullscreen" href="javascript:void(0);">
                                  ...
                                  <svg id="icon-minimize" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="A098AE" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="feather feather-minimize"><path d="M8 3v3a2 2 0 0 1-2 2H3m18 0h-3a2 2 0 0 1-2-2V3m0 18v-3a2 2 0 0 1 2-2h3M3 16h3a2 2 0 0 1 2 2v3" style={{ strokedasharray: '37, 57', strokedashoffset: '0' }}></path></svg>
                                </a>
                              </li>
                    ...
                    {/* <li className="nav-item dropdown notification_dropdown search-area-header ">
                      <a className="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown" style={{ backgroundColor: 'white', padding: '8px', borderRadius: '6px' }}>
                        <i className="bi bi-search" style={{ fontSize: '20px', color: 'black' }}></i>
                          ...
                          <div className="card-body px-0">
                            ...
                            <div className="dlab-scroll px-3 mt-3 height300">
                              <ul className="d-flex align-items-center mb-3">
                                <li>
                                  <img src="/eduassets/images/avatar/1.jpg" className="avatar avatar-sm" alt="" />
                                  <a href="javascript:void(0);" className="ms-2">Benjamin</a>
                              ...
                              <ul className="d-flex align-items-center mb-3">
                                <li>
                                  <img src="/eduassets/images/avatar/2.jpg" className="avatar avatar-sm" alt="" />
                                  <a href="javascript:void(0);" className="ms-2">Oliver</a>
                                </li>
                                <li className="ms-auto"><i className="fa-solid fa-trash"></i></li>
                              </ul>
                              <ul className="d-flex align-items-center mb-3">
                                <li>
                                  <img src="/eduassets/images/avatar/1.jpg" className="avatar avatar-sm" alt="" />
                                  <a href="javascript:void(0);" className="ms-2">Lucas</a>
                              ...
                              <ul className="d-flex align-items-center mb-3">
                                <li>
                                  <img src="/eduassets/images/avatar/4.jpg" className="avatar avatar-sm" alt="" />
                                  <a href="javascript:void(0);" className="ms-2">Benjamin</a>
                              ...
                              <ul className="d-flex align-items-center mb-3">
                                <li>
                                  <img src="/eduassets/images/avatar/3.jpg" className="avatar avatar-sm" alt="" />
                                  <a href="javascript:void(0);" className="ms-2">Benjamin</a>
                              ...
                              <ul className="d-flex align-items-center mb-3">
                                <li>
                                  <img src="src/eduassets/images/avatar/2.jpg" className="avatar avatar-sm" alt="" />
                                  <a href="javascript:void(0);" className="ms-2">Benjamin</a>
                        ...
                        <div id="DZ_W_Notification1" className="widget-media dlab-scroll p-3" style={{ height: "380px" }}>
                          <ul className="timeline">
                            <li>
                              <div className="timeline-panel">
                                <div className="media me-2">
                                  <img alt="image" width="50" src="src/eduassets/images/avatar/1.jpg" />
                                </div>
                            ...
                            <li>
                              <div className="timeline-panel">
                                <div className="media me-2">
                                  <img alt="image" width="50" src="/eduassets/images/avatar/1.jpg" />
                                </div>
                                <div className="media-body">
                                  <h6 className="mb-1">Dr sultads Send you Photo</h6>
                                  <small className="d-block">29 July 2020 - 02:26 PM</small>
                    ...
                    <li className="nav-item">
                      <div className="dropdown header-profile2">
                        {/* <a className="nav-link ms-0" href="javascript:void(0);" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                          <div className="header-info2 d-flex align-items-center">
                            <div className="d-flex align-items-center sidebar-info">

                            </div>
                            <img src="/eduassets/images/dummy.jpg" alt="" />
                          </div>
                        </a> */}
                          ...
                          <div className="card mb-0">
                            <div className="card-header p-3">
                              <ul className="d-flex align-items-center">
                                <li>
                                  <img src="/eduassets/images/dummy.jpg" className="ms-0" alt="" />
                                </li>
                                <li className="ms-2">
                            ...
                            <div className="card-body p-3">
                              {/* <a href="" className="dropdown-item ai-icon ">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" className="svg-main-icon">
                              ...
                              <a href="/admin/changepassword" className="dropdown-item ai-icon ">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" className="svg-main-icon">
                                  <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <rect x="0" y="0" width="24" height="24" />
                              ...
                              <a href="/admin/editprofile" className="dropdown-item ai-icon ">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" className="svg-main-icon">
                                  <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <rect x="0" y="0" width="24" height="24" />
                            ...
                            {/* <div className="card-footer text-center p-3">
                              <a href="/admin/logout" className="dropdown-item ai-icon btn btn-primary light">
